...
export default function OrphanageDetails () {
  function handleOpenGoogleMapsOnCoordinates () {
    Linking.openURL(`http://maps.google.com/?q=${-27.2092052},${-49.6401092}`)
  }

  function handleSendWhatsapp () {
    Linking.openURL('whatsapp://send?phone=5593940028922&text=Olá, gostaria de marcar um horário para visita.')
  }
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity onPress={handleOpenGoogleMapsOnCoordinates} style={styles.routesContainer}>
